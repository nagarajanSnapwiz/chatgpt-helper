...
function _runWithToolsUntilComplete() {
  _runWithToolsUntilComplete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref3) {
    var api, prompt, tools, _ref3$model, model, _ref3$messages, messages, opts, complete, lastMessage, _chatCompletion$choic2, chatCompletion, _chatCompletion$choic, message, _message$function_cal, functionName, _message$function_cal2, _args, functionArgument, functionResult;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return api.chat.completions.create(_extends({
            model: model,
            messages: messages,
        ...
        case 7:
          ...
          _chatCompletion$choic = (_chatCompletion$choic2 = chatCompletion.choices) == null ? void 0 : _chatCompletion$choic2[0], message = _chatCompletion$choic.message;
          lastMessage = message;
          if (!message) {
            _context.next = 24;
            break;
...
function _extractDataWithPrompt() {
  _extractDataWithPrompt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref4) {
    var _chatCompletion$choic3, _chatCompletion$choic4, _chatCompletion$choic5;
    var api, schema, content, _ref4$metadataDescrip, purpose, opts, fn, _opts$model, model, otherOpts, chatCompletion, _chatCompletion$choic7, _chatCompletion$choic6, message;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          if (!((_chatCompletion$choic3 = chatCompletion.choices) != null && (_chatCompletion$choic4 = _chatCompletion$choic3[0]) != null && (_chatCompletion$choic5 = _chatCompletion$choic4.message) != null && _chatCompletion$choic5.function_call)) {
            _context2.next = 11;
            break;
          }
          _chatCompletion$choic6 = (_chatCompletion$choic7 = chatCompletion.choices) == null ? void 0 : _chatCompletion$choic7[0], message = _chatCompletion$choic6.message;
...
exports.extractStreamWithPrompt = extractStreamWithPrompt;
exports.getParameterFromZod = getParameterFromZod;
