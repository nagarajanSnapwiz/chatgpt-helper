...
type RunWithToolsUntilCompleteArgs = {
    ...
    prompt: string;
    tools: Tools;
} & Partial<Exclude<OpenAI.Chat.Completions.ChatCompletionCreateParamsNonStreaming, 'functions' | 'function_call'>>;
export declare function runWithToolsUntilComplete({ api, prompt, tools, model, messages, ...opts }: RunWithToolsUntilCompleteArgs): Promise<{
    ...
    lastMessage: OpenAI.Chat.Completions.ChatCompletionMessage | undefined;
}>;
...
} & Partial<Omit<OpenAI.Chat.Completions.ChatCompletionCreateParamsNonStreaming, 'messages' | 'functions' | 'function_call'>>): Promise<{
    data: string;
...
export declare function extractStreamWithPrompt({ api, schema, prompt: content, metadataDescription: purpose, ...opts }: {
    ...
    prompt: string;
    metadataDescription?: string;
} & Partial<Omit<OpenAI.Chat.Completions.ChatCompletionCreateParamsStreaming, 'messages' | 'functions' | 'function_call'>>): Promise<Readable>;
export {};
